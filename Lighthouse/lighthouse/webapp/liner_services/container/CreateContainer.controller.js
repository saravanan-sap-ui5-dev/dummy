sap.ui.define([
    ...
    "use strict";
    var that = this;
    return BaseController.extend("com.lighthouse.liner_services.container.CreateContainer", {
        ...
        onInit: function () {
            ...
            this.oRouter.getRoute("containerInUseDetailCreate").attachMatched(this._onRouteCreateMatched, this);
            ...
            [this.pageId, this.popoverBtn, this.formId, this.cargoDetailTableId] = [this.getView().byId("page_CreateContainer"), this.getView().byId("btnContainerInUseErr"), this.getView().byId("containerInUseForm"), this.getView().byId("cargoDetailTableId")];
        ...
        postContainersInUse: async function () {
            try {
                ...
                if (valid.length == 0) {
                    ...
                    oData.cargoDetails.items.map(e=>e.status=2);
