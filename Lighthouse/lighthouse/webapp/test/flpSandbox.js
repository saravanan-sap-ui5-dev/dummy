		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Lighthouse",
									"targetURL": "#comlighthouse-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comlighthouse-display": {
								"semanticObject": "comlighthouse",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.lighthouse",
									"url": sap.ui.require.toUrl("com/lighthouse")
								}
							}
						}
					}
