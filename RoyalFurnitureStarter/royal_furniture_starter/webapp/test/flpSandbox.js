		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Royal Furniture Starter",
									"targetURL": "#comroyalfurniturestarter-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comroyalfurniturestarter-display": {
								"semanticObject": "comroyalfurniturestarter",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.royalfurniturestarter",
									"url": sap.ui.require.toUrl("com/royalfurniturestarter")
								}
							}
						}
					}
